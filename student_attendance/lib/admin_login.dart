...
class AdminLoginPageState extends State<AdminLoginPage> with RouteAware {
  final TextEditingController loginIdController1 = TextEditingController();
  final TextEditingController passwordController1 = TextEditingController();
  bool _passwordVisible1 = false;

  final List<Map<String, String>> usersLogin1 = [
    {'loginId': 'AKASH', 'password': 'Akash@1'},
    {'loginId': 'user1b@example.com', 'password': 'passwordB1'},
    {'loginId': 'user1c@example.com', 'password': 'passwordC1'},
  ];
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildLoginBox(
                      title: 'Admin Login',
                      loginIdController: loginIdController1,
  ...
  Widget _buildTextField({
    ...
    return Container(
      ...
      child: TextField(
        ...
        style: TextStyle(
            color: Colors.indigoAccent, fontSize: 16, fontWeight: FontWeight.bold),
